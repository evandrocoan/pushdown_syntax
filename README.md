...
![screenshot](lark_syntax.png)

The `.pushdown` file extension is associated with the Lark Grammar.
...
1. Then, search for `PushdownParserSyntax` and press <kbd>Enter</kbd>
